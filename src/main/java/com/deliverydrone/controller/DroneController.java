...
public class DroneController {
  ...
  public ResponseEntity<Float> checkDroneBatteryLevelById(@PathVariable Long id) {
  ...
  public ResponseEntity<DroneDto> updateDroneState(@RequestBody String droneState, @PathVariable Long id) {
